    ...
    <section id="equipo" className="px-6 lg:px-16 py-16 border-t border-border scroll-mt-20">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-5">
          ...
          <div className="relative flex flex-col p-7 md:p-8 bg-card border border-border overflow-hidden">
            <div className="inline-flex items-center gap-1.5 self-start text-[10px] font-black uppercase tracking-[0.16em] px-2.5 py-1 mb-4 text-primary border border-primary/40">
