...
const horarios: Record<string, ClaseEnriquecida[]> = {
  ...
  Martes: [
    ...
    { sede: "Rosedal", hora: "19:00", disciplina: "Primeros pasos" },
    { sede: "Rosedal", hora: "20:00", disciplina: "Frenadas" },
  ],
  Miércoles: [
    { sede: "Villa Real", hora: "18:00", disciplina: "Primeros pasos" },
    { sede: "Villa Real", hora: "19:00", disciplina: "Primeros pasos" },
    { sede: "Belgrano", hora: "19:00", disciplina: "Primeros pasos" },
  ...
  Jueves: [
    { sede: "P. Rivadavia", hora: "19:00", disciplina: "Primeros pasos" },
    { sede: "Colegiales", hora: "19:00", disciplina: "Primeros pasos" },
    { sede: "Rosedal", hora: "19:00", disciplina: "Primeros pasos" },
  ...
  Domingo: [
    { sede: "P. Rivadavia", hora: "08:00", disciplina: "Primeros pasos" },
    { sede: "P. Rivadavia", hora: "09:00", disciplina: "Nivel principiante" },
    { sede: "P. Rivadavia", hora: "09:00", disciplina: "Slalom" },
    { sede: "Plaza La Pampa", hora: "08:00", disciplina: "Primeros pasos" },
    { sede: "Rosedal", hora: "09:00", disciplina: "Primeros pasos" },
    { sede: "Fac. Medicina", hora: "10:00", disciplina: "Primeros pasos" },
  ],
};
